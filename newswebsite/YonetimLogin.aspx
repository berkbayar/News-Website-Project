<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YonetimLogin.aspx.cs" Inherits="newswebsite.YonetimLogin" %>
                    ...
                    <div class="form-horizontal">
                        <div class="form-body pal">
                            <div class="col-md-12 text-center">
                                <h1 style="margin-top: -90px; font-size: 48px;">Admin Panel</h1>
                                <br />
                            </div>
                                ...
                                <div class="col-lg-12" align="right">
                                    <div class="form-group mbn">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <asp:Button ID="btnGiris" CssClass="btn btn-primary" runat="server" Text="Giriş" OnClick="Button1_Click" />
                                        </div>
                                    </div>
                                </div>
                            </div>
